...
void io_module_init(Allocator *allocator){
    ...
    factory_add_native_fn("open", 2, native_fn_io_open, io_native_module);
    factory_add_native_fn("close", 1, native_fn_io_close, io_native_module);
    factory_add_native_fn("is_closed", 1, native_fn_io_is_closed, io_native_module);
    factory_add_native_fn("len", 1, native_fn_io_len, io_native_module);
    factory_add_native_fn("pos", 1, native_fn_io_pos, io_native_module);
    factory_add_native_fn("read_byte", 1, native_fn_io_read_byte, io_native_module);
    factory_add_native_fn("read_bytes", 2, native_fn_io_read_bytes, io_native_module);
}
