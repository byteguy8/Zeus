...
Obj *native_list_get(char *symbol, void *target, VM *vm){
    if(!list_symbols){
        list_symbols = runtime_lzhtable();
        runtime_add_native_fn_info("size", 0, native_fn_list_size, list_symbols);
        runtime_add_native_fn_info("capacity", 0, native_fn_list_capacity, list_symbols);
        runtime_add_native_fn_info("available", 0, native_fn_list_available, list_symbols);
        runtime_add_native_fn_info("first", 0, native_fn_list_first, list_symbols);
        runtime_add_native_fn_info("last", 0, native_fn_list_last, list_symbols);
        runtime_add_native_fn_info("reverse", 0, native_fn_list_reverse, list_symbols);
        runtime_add_native_fn_info("get", 1, native_fn_list_get, list_symbols);
        runtime_add_native_fn_info("insert", 1, native_fn_list_insert, list_symbols);
        runtime_add_native_fn_info("insert_at", 2, native_fn_list_insert_at, list_symbols);
        runtime_add_native_fn_info("set", 2, native_fn_list_set, list_symbols);
        runtime_add_native_fn_info("append", 1, native_fn_list_append, list_symbols);
        runtime_add_native_fn_info("remove", 1, native_fn_list_remove, list_symbols);
        runtime_add_native_fn_info("clear", 0, native_fn_list_clear, list_symbols);
    }
